...
/**
 * adater of company info viewpager 商家信息页卡适配器
 * Created by 超 on 2016/1/27.
 */
public class CompanyInfoAdapter extends PagerAdapter {
    /**
     ...
     * @param views view列表
     */
    public CompanyInfoAdapter(ArrayList<View> views, ArrayList<String> Tabs) {
        mVies = views;
        mTabs = Tabs;
    }

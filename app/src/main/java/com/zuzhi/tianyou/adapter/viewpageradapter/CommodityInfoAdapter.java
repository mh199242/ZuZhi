...
/**
 * adater of commodity viewpager 商品详情页卡适配器
 * Created by 超 on 2016/1/27.
 */
public class CommodityInfoAdapter extends PagerAdapter {
    /**
     ...
     * @param views view列表
     */
    public CommodityInfoAdapter(ArrayList<View> views, ArrayList<String> Tabs) {
        mVies = views;
        mTabs = Tabs;
    }
